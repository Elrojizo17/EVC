                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px" }}>
                        ...
                        <div>
                            <label style={labelStyle}>
                                Tecnología anterior {formNovedad.tipo_novedad === "CAMBIO_TECNOLOGIA" ? "*" : ""}
                            </label>
                            <input
                                type="text"
                                ...
                                onChange={handleChangeNovedad}
                                onBlur={handleBlurNovedad}
                                required={formNovedad.tipo_novedad === "CAMBIO_TECNOLOGIA"}
                                style={inputStyle}
                                placeholder="Sodio"
                                disabled={formNovedad.tipo_novedad !== "CAMBIO_TECNOLOGIA"}
                            />
                        </div>

                        <div>
                            <label style={labelStyle}>
                                Tecnología nueva {formNovedad.tipo_novedad === "CAMBIO_TECNOLOGIA" ? "*" : ""}
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label style={labelStyle}>
                                Elemento de reemplazo {formNovedad.tipo_novedad === "CAMBIO_TECNOLOGIA" ? "*" : ""}
                            </label>
                            <select
